...
void makeCuratedPairFile_pAu()
{
  ...
  TFile *fillFile = TFile::Open( "fill_pAu.root" );
  ...
  TFile *inputFile = TFile::Open( "../pAu_goodruns_ana664.root" );
  ...
  skipEntriesFile.open( "multiesPair_pAu.txt" );

  if (!skipEntriesFile.is_open()) 
  {
    cout << "!!!!! File multiesPair_pAu.txt was not found... Abort mission!!!!!" << endl;
    break;
  }
  int skipIndex;
  ...
  for( int i = 0; i < numEntries; i++ )
	...
	cout << "Processed " << i << " photon pairs " << endl;
     ...
     // these fills all have 0 polarization from the spin DB -- come back to this if I get an updated polarization list from the polarimetry group
     // if (fillNumber==19072 || runNumber==434160 || fillNumber==19079 || fillNumber==19102 || fillNumber==19126 || fillNumber==19128 || fillNumber==19136 || fillNumber==19151 || fillNumber==19158) {continue;}
