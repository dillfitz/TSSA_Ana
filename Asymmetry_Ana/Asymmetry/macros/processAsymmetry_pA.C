...
//const int SQRT = 2;
void processAsymmetry_pA( const char* particle = "eta", const char* collisionSystem = "pAu", const bool background = true, const bool dpBackground = false, const bool isolated = false )
