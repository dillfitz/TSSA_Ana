...
const char *names[6] = { "lumiY_minus", "lumiB_minus", "lumi_minus", "sqrtY_minus", "sqrtB_minus",  "sqrt_minus" };
...
void plotCompareFormulasMinus( const char* particle = "ohfe" )
{
