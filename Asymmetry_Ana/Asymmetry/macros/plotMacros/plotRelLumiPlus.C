...
const char *names[ numGraphs ] = { "lumiYL_plus", "lumiYR_plus", "lumiBL_plus", "lumiBR_plus"};
...
void plotRelLumiPlus( const char* particle = "ohfe" )
{
  ...
  if( SAVE_IMAGES )
    {
      ...
      name += particle;
      name += "/RelLumi/";
      name += "lumiLeftRightYellowPlus.png";
      c20->SaveAs( name );
    }
  ...
  if( SAVE_IMAGES )
    {
      ...
      name += particle;
      name += "/RelLumi/";
      name += "lumiLeftRightBluePlus.png";
      c41->SaveAs( name );
    }
  ...
  ttestYLR->GetXaxis()->SetLimits(0, 6);
  ttestYLR->Draw( "AP" );
  zeroLine->Draw( "same" );
  ...
  if( SAVE_IMAGES )
    {
      ...
      name += particle;
      name += "/RelLumi/";
      name += "lumiLeftRightYellowPlusTTest.png";
      c35->SaveAs( name );
    }
  ...
  ttestBLR->GetXaxis()->SetLimits(0, 6);
  ttestBLR->Draw( "AP" );
  zeroLine->Draw( "same" );
  ...
  if( SAVE_IMAGES )
    {
      ...
      name += particle;
      name += "/RelLumi/";
      name += "lumiLeftRightBluePlusTTest.png";
      c45->SaveAs( name );
    }
