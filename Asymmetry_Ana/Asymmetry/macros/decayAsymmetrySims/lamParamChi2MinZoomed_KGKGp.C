...
void lamParamChi2MinZoomed_KGKGp()
{
  ...
  TCanvas *candiv_minus = new TCanvas();
	int counter = 0;
	candiv_plus->Divide(5,2);
	candiv_minus->Divide(5,2);
  ...
  KGs_1sig_graph->GetXaxis()->SetLimits(-0.004, 0.004);    
