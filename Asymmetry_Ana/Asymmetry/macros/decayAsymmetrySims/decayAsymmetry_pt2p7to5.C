...
void decayAsymmetry_pt2p7to5()
{
  ...
  TFile *outFile = new TFile("dataFiles/jpsiDecayAsymmetry_ptbin2p7to5.root", "RECREATE");
  ...
  nomx.Draw("SAME");
  nomy.Draw("SAME");
  c1->SaveAs("images/dilutions_ptbin2p7to5.png");

  TCanvas *c2 = new TCanvas("c2");
  jphis[5]->Draw();
  c2->SaveAs("images/jphiAN_pt2p7to5.png");
  
  TCanvas *c3 = new TCanvas("c3");
  ephis[5]->Draw();
  c3->SaveAs("images/ephiAN_pt2p7to5.png");

  TCanvas *c4 = new TCanvas("c4");
  ejpsiphi->Draw("COLZ");
  c4->SaveAs("images/ejpsiphi_pt2p7to5.png");
