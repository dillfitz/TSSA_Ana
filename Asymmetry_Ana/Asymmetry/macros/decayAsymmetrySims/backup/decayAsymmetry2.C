...
void decayAsymmetry2()
{
  ...
  TFile *outFile = new TFile("jpsiDecayAsymmetry_ptbin3.root", "RECREATE");
  ...
  decayTree->Draw("phi>>jphi_presel","pt1>2.1&&pt1<2.7");
