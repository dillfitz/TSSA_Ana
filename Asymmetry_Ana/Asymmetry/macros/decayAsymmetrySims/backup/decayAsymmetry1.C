...
void decayAsymmetry1()
{
  ...
  TFile *outFile = new TFile("jpsiDecayAsymmetry_ptbin2.root", "RECREATE");
  ...
  decayTree->Draw("phi>>jphi_presel","pt1>1.8&&pt1<2.1");
