...
void sysplots_plus()
{
  ...
  TFile* infile1= TFile::Open("outputFiles/normalizations_plus.root");
  ...
  TFile* infile2 = TFile::Open("outputFiles/systematics_plus.root");
  ...
  c1->SaveAs("normalizations_w_sys_plus.png");
  c1->SaveAs("normalizations_w_sys_plus.pdf");  
