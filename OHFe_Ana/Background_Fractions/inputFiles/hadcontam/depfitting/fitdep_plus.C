...
void fitdep_plus()
{
  ...
  if (nv)
    {
      TFile* infile1 = TFile::Open("dataFiles/depstudy_noveto_plus.root");
      outfileName += "_noveto";
    }
  else
    {
      TFile* infile1 = TFile::Open("dataFiles/depstudy_plus.root");
    }
  ...
  TFile* infile2 = TFile::Open("dataFiles/hadronfits_plus.root");
  ...
  if (nv == 0)
    c1->SaveAs("electroncanddep_plus.png");
